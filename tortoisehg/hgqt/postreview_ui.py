...
class Ui_PostReviewDialog(object):
    def setupUi(self, PostReviewDialog):
        ...
        self.post_review_button.clicked.connect(PostReviewDialog.accept) # type: ignore
        self.settings_button.clicked.connect(PostReviewDialog.onSettingsButtonClicked) # type: ignore
        self.close_button.clicked.connect(PostReviewDialog.close) # type: ignore
        self.outgoing_changes_check.toggled['bool'].connect(PostReviewDialog.outgoingChangesCheckToggle) # type: ignore
        self.branch_check.toggled['bool'].connect(PostReviewDialog.branchCheckToggle) # type: ignore
        self.tab_widget.currentChanged['int'].connect(PostReviewDialog.tabChanged) # type: ignore
